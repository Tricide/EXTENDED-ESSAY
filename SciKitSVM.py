...
linear_svm_test_scores.append(linear_svm.score(test_X, test_y))
sig_svm_test_scores.append(sig_svm.score(test_X, test_y))
'''
...
sb.boxplot(data=[rbf_svm_test_scores, polynomial_svm_test_scores], notch=True)
plt.xticks([0, 1], ['RBFSVM', 'PolynomialSVM'])
